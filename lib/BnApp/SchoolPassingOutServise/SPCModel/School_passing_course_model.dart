...
List<SPassingourseModel> sLoalourseModelFromJson(String str) => List<SPassingourseModel>.from(json.decode(str).map((x) => SPassingourseModel.fromJson(x)));

String sLoalourseModelToJson(List<SPassingourseModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class SPassingourseModel {
  String? schoolName;
  String ?course;
  dynamic nbcdStatus;
  ...
  factory SPassingourseModel.fromJson(Map<String, dynamic> json) => SPassingourseModel(
