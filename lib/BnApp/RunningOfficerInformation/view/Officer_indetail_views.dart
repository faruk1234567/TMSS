...
class TotalOfficerDataSearch extends StatefulWidget {
  TotalOfficerDataSearch({Key? key, required this.course});
  String? course;
  //String? courseTitle;

  @override
  State<TotalOfficerDataSearch> createState() => _DataSearchState();
}

class _DataSearchState extends State<TotalOfficerDataSearch> {
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: CupertinoSearchTextField(
                    onChanged: (value) {
                      setState(() {
                        controller.searchforOfficer(value);
              ...
              Expanded(
                child: DataTableWidget(
                  data: controller.totalofficerList.where(
...
class DataTableWidget extends StatelessWidget {
  final List<OfficerModel> data;
  final TotalOfficerController controller;
...
class LocalCourseGridSource extends DataGridSource {
 ...
 final  TotalOfficerController controller;
  ...
  late List<OfficerModel> LocalCourseDataList;
  ...
  List<DataGridRow> get rows  {
    ...
    List<OfficerModel> listToUse = controller.forOfficerSearch.isNotEmpty ? controller.forOfficerSearch : LocalCourseDataList;

    return listToUse.asMap().entries.map<DataGridRow>((entry) {
          int index = entry.key;
          OfficerModel dataRows = entry.value;
