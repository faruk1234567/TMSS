...
import 'package:navy_project/BnApp/SailorsInformation/view/sailors_indetail_views.dart';

import '../controller/sailors_controller.dart';

class SailorsCourseListScreen extends StatefulWidget {
  const SailorsCourseListScreen({super.key});

  @override
  State<SailorsCourseListScreen> createState() => _BnDataSchoolsScreenState();
}

class _BnDataSchoolsScreenState extends State<SailorsCourseListScreen> {
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Sailors CourseList",style: TextStyle(
              fontSize: 24,
