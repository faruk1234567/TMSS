...
import '../controller/Bna_sub_list_controller.dart';
...
class BnaSubjectPage extends StatelessWidget {
  BnaSubjectPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("SublectList List",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.indigo)),
      ),
  ...
  return <GridColumn>[
    ...
    GridColumn(
      ...
      label: Container(
        padding: const EdgeInsets.all(8),
        alignment: Alignment.center,
        child: const Text('ExamTime', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black, fontSize: 25)),
      ),
    ),
  ...
  void buildDataGridRow() {
    dataGridRows = BnaSlirt.asMap().entries.map<DataGridRow>((entry) {
      ...
      return DataGridRow(cells: [
        ...
        DataGridCell<String>(columnName: 'Duration', value:datarows.totalMark),
        DataGridCell<String>(columnName: 'Candidates', value: datarows.passMarkBNA ),
        DataGridCell<String>(columnName: 'Candidates', value: datarows.examDate.toString()=="null"?" ":datarows.examDate ),
        DataGridCell<String>(columnName: 'Candidates', value: datarows.qExamTime ),
