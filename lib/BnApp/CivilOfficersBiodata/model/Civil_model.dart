class CivilOfficerBioModel {
  ...
  CivilOfficerBioModel.fromJson(Map<String, dynamic> json) {
    if (json['items'] != null) {
      items = <Items>[];
...
class Items {
  ...
  dynamic? pantSize;
  dynamic? nominee;
  dynamic? closeRelative;
  dynamic? relativeRelation;
  String? mobile;
  String? email;
  String? bnaPhotoUrl;
  dynamic? bnaNo;
