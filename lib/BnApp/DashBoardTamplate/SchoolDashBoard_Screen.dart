...
import 'package:navy_project/BnApp/SchoolPassingOutServise/SPCController/School_passing_course_controller.dart';
import 'package:navy_project/BnApp/SchoolUpcommingCourse/SUCController/School_upcomming_controller.dart';
...
import '../SchoolLocalCourseServise/SLCController/School_local_course_controller.dart';
import '../SchoolLocalCourseServise/SLCViews/SLC_Views.dart';
import '../SchoolPassingOutServise/SPCViews/School_passing_course_views.dart';
import '../SchoolUpcommingCourse/SUCViews/School_upcomming_course_view.dart';
...
class SchoolDashBoardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final SchoolUpcommingCourseController schoolUpcommingCourseController=Get.put(SchoolUpcommingCourseController());
    void logout() {
                ...
                child: GridView.count(
                  ...
                  children: [
                    _buildCard(context, 'Running\nCourse', Icons.people,
                        onPressed: () async{
                      await schoolLocalCourseController.getSchoolDetailData(
                      bSchoolId: storage.read('branchId'));
                      await schoolLocalCourseController.getSchoollocalCourses().then((_){
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SchoolLocalCourseList()));
                    });
                        }),
                    _buildCard(context, 'Passing\nOut', Icons.school,
                        onPressed: ()async {
                      await schoolPassingCourseController.getSchoolDetailData(
                          bSchoolId: storage.read('branchId')

                      );
                      await schoolPassingCourseController.getSchoolPassingCourses(
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => SchoolPassingCourseList()));
                      });
                    }),
                    _buildCard(context, 'UpComing', Icons.class_,
                        onPressed: () async{
                          ...
                          await schoolUpcommingCourseController.getSchoolUpcommingCourses(
