...
import '../controller/School_rutine_controller.dart';
...
class SchoolRutineViewPage extends StatelessWidget {
  SchoolRutineViewPage({super.key});

  final SchoolRutineController controller = Get.put(SchoolRutineController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Rutine Note List",style: TextStyle(
              fontSize: 24,
        ...
        body: SfDataGridTheme(
          ...
          child: Obx(
                ...
                children: [
                  Expanded(
                    child: SfDataGrid(
                        source: LocalCourseGridSource(controller.SRutineDetails),
                        columns: getColumns(),
                      ...
                      OutlinedButton(
                        onPressed: () async {
                          if (controller.pageNumber.value != 1) {
                            ...
                            await controller.getSchoolRutineData();
                          }
                        },
                        child: Text("Previous"),
                      ),
  ...
  void buildDataGridRow() {
    dataGridRows = LocalCourseDataList.asMap().entries.map<DataGridRow>((entry) {
      ...
      return DataGridRow(cells: [
        ...
        DataGridCell<String>(columnName: 'Instructor', value: '${datarows.courseName} '),
        DataGridCell<String>(columnName: 'shortCode', value: '${datarows.routineNotes}  '),
