...
class SchoolOfficersDataSearch extends StatefulWidget {
  SchoolOfficersDataSearch({Key? key, required this.course});
  String? course;
  //String? courseTitle;

  @override
  State<SchoolOfficersDataSearch> createState() => _DataSearchState();
}

class _DataSearchState extends State<SchoolOfficersDataSearch> {
  ...
  Widget build(BuildContext context) {
    return  PopScope(
      onPopInvoked: (_)=>controller.OfficeSearchList.clear(),
      child: Scaffold(
        ...
        appBar: AppBar(
          leading: IconButton(
            onPressed: (){
              controller.OfficeSearchList.clear();
              Get.back();
            },
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: CupertinoSearchTextField(
                  onChanged: (value) {
                    setState(() {
                      controller.forOfficerSearch(value);
            ...
            Expanded(
              child: DataTableWidget(
                data: controller.SchoolOfficersDataList.where(
...
class DataTableWidget extends StatelessWidget {
  final List<SchoolOfficersModel> data;
  final SchoolOfficersTraineeController controller;
...
class LocalCourseGridSource extends DataGridSource {
  ...
  late List<SchoolOfficersModel> LocalCourseDataList;
  ...
  List<DataGridRow> get rows  {
    List<SchoolOfficersModel>ListtoUse= controller.OfficeSearchList.isNotEmpty ? controller.OfficeSearchList:LocalCourseDataList;
    return
      ListtoUse.asMap().entries.map<DataGridRow>((entry) {
          int index = entry.key;
          SchoolOfficersModel dataRows = entry.value;
