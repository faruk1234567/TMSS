...
import 'package:navy_project/SchoolApp/Sailors/view/sailors_officers_detail.dart';
...
class SailorOfficersListScreen extends StatefulWidget {
  const SailorOfficersListScreen({super.key});

  @override
  State<SailorOfficersListScreen> createState() => _BnDataSchoolsScreenState();
}

class _BnDataSchoolsScreenState extends State<SailorOfficersListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text(" Sailors Officer List",style: TextStyle(
            fontSize: 24,
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                  onTap: () {
                    Get.to(() => SailorOfficersDataSearch(
